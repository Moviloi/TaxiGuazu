...
const ALIASES: Array<{ place_id: string; alias: string; language: string }> = [
  ...
  { place_id: "ar_amerianportal_hotel", alias: "amerian hotel", language: "en" },
  { place_id: "ar_amerianportal_hotel", alias: "amerian portal hotel", language: "en" },
  { place_id: "ar_amerianportal_hotel", alias: "hotel amerian", language: "pt" },
  { place_id: "ar_aripuca_attraction", alias: "aripuca", language: "es" },
  { place_id: "ar_aripuca_attraction", alias: "la aripuca", language: "es" },
  { place_id: "ar_aripuca_attraction", alias: "aripuca park", language: "en" },
  { place_id: "ar_aripuca_attraction", alias: "parque aripuca", language: "pt" },
  ...
  { place_id: "ar_cataratas_attraction", alias: "argentine side falls", language: "en" },
  { place_id: "ar_cataratas_attraction", alias: "cataratas lado argentino", language: "pt" },
  ...
  { place_id: "ar_duty_free_shopping", alias: "duty free puerto iguazu", language: "pt" },
  { place_id: "ar_duty_free_shopping", alias: "loja duty free", language: "pt" },
  ...
  { place_id: "ar_falls_iguazu_hotel", alias: "falls iguazu hotel", language: "en" },
  { place_id: "ar_falls_iguazu_hotel", alias: "hotel falls iguazu", language: "es" },
  { place_id: "ar_falls_iguazu_hotel", alias: "hotel falls iguazú", language: "pt" },
  { place_id: "ar_feria_shopping", alias: "feirinha", language: "pt" },
  { place_id: "ar_feria_shopping", alias: "la feirinha", language: "es" },
  { place_id: "ar_feria_shopping", alias: "feirinha market", language: "en" },
  { place_id: "ar_feria_shopping", alias: "fair market", language: "en" },
  { place_id: "ar_grand_resort", alias: "iguazu grand", language: "en" },
  { place_id: "ar_grand_resort", alias: "iguazú grand", language: "es" },
  { place_id: "ar_grand_resort", alias: "iguazu grand resort", language: "en" },
  { place_id: "ar_grand_resort", alias: "iguazú grand resort", language: "pt" },
  { place_id: "ar_guira_attraction", alias: "guira oga", language: "es" },
  { place_id: "ar_guira_attraction", alias: "guira oga reserve", language: "en" },
  { place_id: "ar_guira_attraction", alias: "reserva guira oga", language: "pt" },
  ...
  { place_id: "ar_hito_attraction", alias: "three borders landmark", language: "en" },
  { place_id: "ar_hito_attraction", alias: "marco das tres fronteiras", language: "pt" },
  { place_id: "ar_hito_attraction", alias: "three frontiers", language: "en" },
  { place_id: "ar_icebar_attraction", alias: "bar de hielo", language: "es" },
  { place_id: "ar_icebar_attraction", alias: "icebar", language: "en" },
  { place_id: "ar_icebar_attraction", alias: "bar de gelo", language: "pt" },
  ...
  { place_id: "ar_loi_suites_hotel", alias: "loi suites iguazú", language: "pt" },
  ...
  { place_id: "ar_mercure_hotel", alias: "mercure iguazu", language: "pt" },
  ...
  { place_id: "ar_o2_hotel", alias: "o2 iguazú", language: "pt" },
  { place_id: "ar_panoramic_grand", alias: "panoramic", language: "es" },
  { place_id: "ar_panoramic_grand", alias: "panoramic grand", language: "en" },
  { place_id: "ar_panoramic_grand", alias: "panoramic grand hotel", language: "en" },
  { place_id: "ar_panoramic_grand", alias: "panoramic grand iguazú", language: "pt" },
  ...
  { place_id: "ar_saint_george_hotel", alias: "são george", language: "pt" },
  ...
  { place_id: "ar_san_ignacio_attraction", alias: "san ignacio ruins", language: "en" },
  { place_id: "ar_san_ignacio_attraction", alias: "ruínas de san ignacio", language: "pt" },
  { place_id: "ar_san_ignacio_attraction", alias: "san ignacio mission", language: "en" },
  { place_id: "ar_wanda_attraction", alias: "minas de wanda", language: "es" },
  { place_id: "ar_wanda_attraction", alias: "wanda", language: "es" },
  { place_id: "ar_wanda_attraction", alias: "wanda mines", language: "en" },
  { place_id: "ar_wanda_attraction", alias: "minas de wanda", language: "pt" },
  ...
  { place_id: "br_bella_italia", alias: "bella italia hotel", language: "en" },
  { place_id: "br_bella_italia", alias: "hotel bella italia", language: "es" },
  ...
  { place_id: "br_belmond_hotel", alias: "hotel das cataratas", language: "es" },
  ...
  { place_id: "br_bourbon_hotel", alias: "bourbon cataratas", language: "es" },
  { place_id: "br_buddhist_attraction", alias: "templo budista", language: "es" },
  { place_id: "br_buddhist_attraction", alias: "buddhist temple", language: "en" },
  { place_id: "br_buddhist_attraction", alias: "templo budista", language: "pt" },
  ...
  { place_id: "br_churrascaria_rafain", alias: "rafain steakhouse", language: "en" },
  { place_id: "br_churrascaria_rafain", alias: "rafain restaurant", language: "en" },
  ...
  { place_id: "br_doubletree_hotel", alias: "doubletree hilton foz", language: "pt" },
  { place_id: "br_doubletree_hotel", alias: "hilton foz", language: "pt" },
  ...
  { place_id: "br_igu_airport", alias: "aeropuerto de foz", language: "es" },
  { place_id: "br_igu_airport", alias: "aeropuerto foz", language: "es" },
  { place_id: "br_igu_airport", alias: "brazil airport", language: "en" },
  ...
  { place_id: "br_mabu_hotel", alias: "mabu termas", language: "es" },
  { place_id: "br_mabu_hotel", alias: "mabu hotel", language: "en" },
  ...
  { place_id: "br_marco_attraction", alias: "three borders landmark br", language: "en" },
  { place_id: "br_marco_attraction", alias: "marco de las tres fronteras", language: "es" },
  { place_id: "br_yupstar_attraction", alias: "rueda gigante", language: "es" },
  { place_id: "br_yupstar_attraction", alias: "yup star", language: "en" },
  { place_id: "br_yupstar_attraction", alias: "roda gigante", language: "pt" },
  { place_id: "br_yupstar_attraction", alias: "ferris wheel foz", language: "en" },
  ...
  { place_id: "py_casino_acaray_hotel", alias: "acaray", language: "en" },
  { place_id: "py_casino_acaray_hotel", alias: "hotel acaray", language: "pt" },
  ...
  { place_id: "py_cellshop_shopping", alias: "cellshop cde", language: "pt" },
  ...
  { place_id: "py_china_shopping", alias: "china shopping", language: "en" },
  { place_id: "py_china_shopping", alias: "shopping china", language: "pt" },
  ...
  { place_id: "py_del_este_shopping", alias: "del este shopping", language: "en" },
  { place_id: "py_del_este_shopping", alias: "compras paraguai", language: "pt" },
  { place_id: "py_itaipu_attraction", alias: "itaipu paraguay", language: "es" },
  { place_id: "py_itaipu_attraction", alias: "itaipu paraguai", language: "pt" },
  { place_id: "py_itaipu_attraction", alias: "itaipu dam py", language: "en" },
  { place_id: "py_monalisa_shopping", alias: "monalisa", language: "es" },
  { place_id: "py_monalisa_shopping", alias: "mona lisa", language: "en" },
  { place_id: "py_monalisa_shopping", alias: "monalisa shopping", language: "pt" },
  ...
  { place_id: "py_monday_attraction", alias: "cachoeira monday", language: "pt" },
  { place_id: "py_nissei_shopping", alias: "nissei", language: "es" },
  { place_id: "py_nissei_shopping", alias: "nissei shopping", language: "en" },
  { place_id: "py_nissei_shopping", alias: "nissei paraguai", language: "pt" },
  { place_id: "py_paris_shopping", alias: "shopping paris", language: "es" },
  { place_id: "py_paris_shopping", alias: "paris shopping", language: "en" },
  { place_id: "py_paris_shopping", alias: "shopping paris", language: "pt" },
  { place_id: "py_rio_bourbon", alias: "rio bourbon", language: "pt" },
  { place_id: "py_rio_bourbon", alias: "rio hotel cde", language: "es" },
  { place_id: "py_rio_bourbon", alias: "rio bourbon hotel", language: "en" },
  { place_id: "py_sax_shopping", alias: "sax", language: "en" },
  { place_id: "py_sax_shopping", alias: "sax paraguay", language: "en" },
  { place_id: "py_sax_shopping", alias: "sax paraguai", language: "pt" },
  { place_id: "py_sax_shopping", alias: "sax shopping", language: "es" },
  ...
  { place_id: "ar_aduanatn_border", alias: "border checkpoint", language: "en" },
  { place_id: "ar_aduanatn_border", alias: "fronteira", language: "pt" },
  ...
  { place_id: "ar_br_border", alias: "border", language: "en" },
  { place_id: "ar_br_border", alias: "fronteira", language: "pt" },
