...
import type { ExecutionDeps } from "@/lib/pipeline";
...
function makeInput(overrides: Partial<TripExecutionInput> = {}): TripExecutionInput {
  return {
    ...
    pricingResult: {
      ...
      source: "standard",
      explanation: [],
      origin: { place_id: "pi", canonical_name: "Puerto Iguazú", zone_id: null },
      destination: { place_id: "cat", canonical_name: "Cataratas", zone_id: null },
    },
