...
❌ **Definiciones terminológicas:** No puede definir términos — eso pertenece
   a SYSTEM_VOCABULARY.md. Si necesita un término nuevo, debe solicitarse a SYSTEM_VOCABULARY.md.
...
|------|---------------------------|
| Definición de términos | SYSTEM_VOCABULARY.md |
...
└── 02-SYSTEM_VOCABULARY.md ──────────── términos que usa sin redefinir
       ↓
...
**Relación con SYSTEM_VOCABULARY.md:**
...
debe solicitarlo a SYSTEM_VOCABULARY.md.
...
### 5.2 Frontera con SYSTEM_VOCABULARY.md
...
1. Solicitar la definición a SYSTEM_VOCABULARY.md.
...
```
NIVEL I ──────────────────────────────────────────────────────
  CONSTITUTION.md          SYSTEM_VOCABULARY.md
...
4. **Definiciones:** "una hipótesis es..." → eso es SYSTEM_VOCABULARY.md.
...
├── 1. Preliminares
│   ├── 1.1 Propósito
│   ├── 1.2 Autoridad (relación con CONSTITUTION.md y SYSTEM_VOCABULARY.md)
...
**Riesgo:** Definir términos que ya están definidos en SYSTEM_VOCABULARY.md.

**Ejemplo:** "Una hipótesis es una proposición activa..." — eso ya está en
SYSTEM_VOCABULARY.md 6.4.

**Mitigación:**
- Todo término capitalizado (Evidence, Belief, Commitment, etc.) debe
  referenciar a SYSTEM_VOCABULARY.md sin redefinir.
- Si un término no existe en SYSTEM_VOCABULARY.md, no usarlo hasta que se agregue.
...
- ✅ Ningún principio contradice SYSTEM_VOCABULARY.md.
- ✅ Todos los principios tienen derivación explícita a CONSTITUTION.md
  (Sección 13).

### CA2 — Sin definiciones
- ✅ No hay definiciones de términos (eso es SYSTEM_VOCABULARY.md).
- ✅ Todo término capitalizado referencia su definición en SYSTEM_VOCABULARY.md.
- ✅ No introduce términos nuevos sin pasarlos por SYSTEM_VOCABULARY.md primero.
...
de SYSTEM_VOCABULARY.md (Percepción → Evidencia → Conocimiento → Decisión →
...
(SYSTEM_VOCABULARY.md 8.5). Es un concepto ontológico importante sin principios
operativos.
...
| **Dependencia de entrada** | CONSTITUTION.md + SYSTEM_VOCABULARY.md |
